...
<html>
    ...
    <body>
        <h1>MeCaNiCoRdObA</h1>
        <table>
            <caption>LOS DATOS DEL CLIENTE SON:</caption>
       <%
		Class.forName("com.mysql.jdbc.Driver");
		Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/mecanico","root", "");
		Statement s = conexion.createStatement();
		
		ResultSet listado = s.executeQuery (" SELECT *FROM cliente E1 JOIN coche E2 ON (E1.CodCliente=E2.CodCliente) where E1.codCliente="+request.getParameter("codigoCliente"));
